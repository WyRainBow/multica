...
// IssueDecisionData is one decision on the issue. Mirror of
// handler.IssueDecision; superseded state is derived server-side.
type IssueDecisionData struct {
	ID           string `json:"id"`
...
// IssueOpenQuestionData is a question no decision has closed. Mirror of
// handler.IssueOpenQuestion.
type IssueOpenQuestionData struct {
	Ref      string `json:"ref"`
