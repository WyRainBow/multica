 ...
 *
 * No "new document" action. Documents are written from the Docs tab, where the
 * whole set is in view; offering it here invites a second copy of something
 * already written. Attaching one that EXISTS is done from the document, which
 * is where you can see which document you are attaching.
 *
